...
LOCATION
  's3://masatomix-fluent-bit-req-res/fluent-bit-logs/request_response'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://masatomix-fluent-bit-req-res/fluent-bit-logs/request_response/${partition_date}/${hour}/', 
